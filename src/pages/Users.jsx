...
// 			<Column icon="fas fa-scroll" style="" tickets={tickets} status="Backlog" users={users} sortOption={sortOption} />
// 			<Column icon="fas fa-genderless" style={{font-size: '24px;', color: 'rgb(187, 181, 181)'}} tickets={tickets} status="Todo" users={users} sortOption={sortOption} />
